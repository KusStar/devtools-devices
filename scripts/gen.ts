...
const main = async () => {
  ...
  const LICENSE = \`// Copyright 2014 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.
//
// Generated by devtools-devices/scripts/gen.ts
// Originally from https://github.com/ChromeDevTools/devtools-frontend/blob/main/front_end/models/emulation/EmulatedDevices.ts
\n\`

  fs.writeFileSync('${join(ROOT, './dist/index.d.ts')}', header + typings)
  fs.writeFileSync('${join(ROOT, './dist/index.cjs')}',  LICENSE + 'const devices = ' + str + space + 'exports.devices = devices;')
  fs.writeFileSync('${join(ROOT, './dist/index.mjs')}', LICENSE + 'export const devices = ' + str)
